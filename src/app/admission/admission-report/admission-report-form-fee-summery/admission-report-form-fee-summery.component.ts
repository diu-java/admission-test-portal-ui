...
@Component({
  selector: 'app-admission-report-form-fee-summery',
  templateUrl: './admission-report-form-fee-summery.component.html',
  styleUrls: ['./admission-report-form-fee-summery.component.css']
})
export class AdmissionReportFormFeeSummeryComponent implements OnInit{
  search:any='';
  paymentStatus:any=1;

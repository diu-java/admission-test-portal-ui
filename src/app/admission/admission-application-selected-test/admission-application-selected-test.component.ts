...
@Component({
  selector: 'app-admission-application-selected-test',
  templateUrl: './admission-application-selected-test.component.html',
  styleUrls: ['./admission-application-selected-test.component.css']
})
export class AdmissionApplicationSelectedTestComponent implements OnInit{
  code:any='';
  search:any='';
  status:any='';

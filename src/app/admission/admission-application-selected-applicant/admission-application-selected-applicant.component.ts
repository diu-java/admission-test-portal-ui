...
@Component({
  selector: 'app-admission-application-selected-applicant',
  templateUrl: './admission-application-selected-applicant.component.html',
  styleUrls: ['./admission-application-selected-applicant.component.css']
})
export class AdmissionApplicationSelectedApplicantComponent implements OnInit{
  code:any='';
  search:any='';
  status:any='';

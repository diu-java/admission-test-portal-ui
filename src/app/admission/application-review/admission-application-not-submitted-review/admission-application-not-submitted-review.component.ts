...
@Component({
  selector: 'app-application-not-submitted-review',
  templateUrl: './admission-application-not-submitted-review.component.html',
  styleUrls: ['./admission-application-not-submitted-review.component.css']
})
export class AdmissionApplicationNotSubmittedReviewComponent implements OnInit{
  code:any='';
  search:any='';
  status:any=1;

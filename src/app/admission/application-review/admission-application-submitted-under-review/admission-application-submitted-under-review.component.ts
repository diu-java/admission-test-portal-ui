...
@Component({
  selector: 'app-admission-application-submitted-under-review',
  templateUrl: './admission-application-submitted-under-review.component.html',
  styleUrls: ['./admission-application-submitted-under-review.component.css']
})
export class AdmissionApplicationSubmittedUnderReviewComponent implements OnInit{
  code:any='';
  search:any='';
  status:any=2;

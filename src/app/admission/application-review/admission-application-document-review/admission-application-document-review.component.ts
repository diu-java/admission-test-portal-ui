...
@Component({
  selector: 'app-admission-application-document-review',
  templateUrl: './admission-application-document-review.component.html',
  styleUrls: ['./admission-application-document-review.component.css']
})
export class AdmissionApplicationDocumentReviewComponent implements OnInit{
  code:any='';
  search:any='';
  status:any=4;

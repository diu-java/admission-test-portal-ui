...
export class AdmissionDashboardService {
  ...
  getAdmissionDashboardReport(){
    return this.httpClient.get(environment.api_url +'/admission/dashboard').pipe(catchError((error: any, caught: Observable<any>): Observable<any> => {
  ...
  getAdmissionDashboardSeat(){
    return this.httpClient.get(environment.api_url +'/admission/dashboard/seat').pipe(catchError((error: any, caught: Observable<any>): Observable<any> => {
      if(error.status === 404){
        this.toastr.warning(error.error.message !== null ? error.error.message: error.error.error);
      }else{
        this.toastr.error(error.error.error);

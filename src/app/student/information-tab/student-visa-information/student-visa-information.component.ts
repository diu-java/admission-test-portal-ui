...
@Component({
  selector: 'app-student-visa-information',
  templateUrl: './student-visa-information.component.html',
  styleUrls: ['./student-visa-information.component.css']
})
export class StudentVisaInformationComponent implements OnInit{

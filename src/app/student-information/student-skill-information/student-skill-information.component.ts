...
@Component({
  selector: 'app-student-skill-information',
  templateUrl: './student-skill-information.component.html',
  styleUrls: ['./student-skill-information.component.css']
})
export class StudentSkillInformationComponent implements OnInit{
  ...
  getPersonInformationView(){
    this.getStudentSkill(this.studentInformation.studentPerson.id);
  ...
  postStudentSkill() {
    this.studentSkill.studentPersonId = this.studentInformation.studentPerson.id;
